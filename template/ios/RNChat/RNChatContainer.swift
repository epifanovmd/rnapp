...
class RNChatContainer: UIView {
  ...
  override init(frame: CGRect) {
    let module = ChatModuleBuilder.build()
  ...
  private func setupChat() {
    ...
    self.chatViewController.view.frame = self.bounds
    self.chatViewController.view.autoresizingMask = [.flexibleWidth, .flexibleHeight]
  }

...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::visionengine::OcrRect> final {
    static inline margelo::nitro::visionengine::OcrRect fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::visionengine::OcrRect(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::visionengine::OcrRect& arg) {

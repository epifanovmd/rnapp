...
namespace margelo::nitro::ocrengine {
  ...
  /**
   * A struct which can be represented as a JavaScript object (OcrRect).
   */
  struct OcrRect final {
  public:
  ...
  public:
    OcrRect() = default;
    explicit OcrRect(double x, double y, double width, double height): x(x), y(y), width(width), height(height) {}

  public:
    friend bool operator==(const OcrRect& lhs, const OcrRect& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ OcrRect <> JS OcrRect (object)
  template <>
  struct JSIConverter<margelo::nitro::ocrengine::OcrRect> final {
    static inline margelo::nitro::ocrengine::OcrRect fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::ocrengine::OcrRect(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::ocrengine::OcrRect& arg) {

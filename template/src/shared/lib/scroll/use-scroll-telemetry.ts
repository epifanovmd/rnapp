 ...
 *
 * Вызывает тот, кто владеет скроллом: экран — и раздаёт её вниз через
 * ScrollProvider, либо самодостаточный компонент, которому нужны хендлер и
 * анимация в одном месте (тогда телеметрия остаётся локальной).
 *

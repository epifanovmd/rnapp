...
export interface SocketServerToClientEvents extends MessengerSocketServerEvents {}

/** All events the client emits → server listens */
export interface SocketClientToServerEvents extends MessengerSocketClientEvents {}

/**
 * Запись голоса из панели ввода. Захват микрофона абстрагирован: по умолчанию —
 * симуляция (таймер + синтетическая волна, без файла), приложение подставляет
 * реальный бэкенд через `setVoiceRecorderBackend` — см.

...
/**
 * Классификация обновления списка: выбор стратегии применения новых сообщений.
 *
 * Стратегия выбирается **до** применения данных, потому что от неё зависит
 * поведение скролла. Таблица решений реализована чистой функцией.
 *
...
/**
 * Откладывать ли обновление до конца скролла. Структурные изменения дёргают
 * контент под пальцем, а `append`/`prepend`/`content` сами управляют позицией
 * и безопасны.
 */

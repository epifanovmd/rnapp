 ...
 *
 * Пороги задаются пропами в пикселях, а список принимает их долей высоты
 * вьюпорта — поэтому высоту меряет этот же хук. Стартовое значение — высота
 * окна, а не ноль: до первого layout ноль давал бы долю 0.5, то есть полэкрана
 * и для пагинации, и для прижатия к низу.
 */

 ...
 * о других сообщениях (разрешённая цитата, скрытие первого разделителя),
 * посчитано здесь, при построении.
 *
 ...
 * нужен лишь признак «я последний в своей группе» — под этим сообщением
 * рисуется аватар, прижатый к низу (как в iOS).
 */

      ...
      <ScrollView>
        <Content>
          <Text mt={8} color={"textSecondary"}>
            Наведите камеру на борт контейнера — детектор находит номер,
            типоразмер и табличку весов, распознавание идёт на лету, области
            подсвечиваются прямо на экране. Код подтверждается контрольной
            цифрой ISO 6346.
          </Text>

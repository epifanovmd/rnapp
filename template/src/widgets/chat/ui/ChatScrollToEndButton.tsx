...
/** Зазор между кнопкой и занятым краем панели ввода. */
const GAP = 2;
const FADE_DURATION = 250;

export interface IChatScrollToEndButtonProps {
  /**
   * Живой след правого края панели ввода: кнопка держится над ним и едет с
   * клавиатурой в один кадр с панелью.
   */
